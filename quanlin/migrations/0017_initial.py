...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'quanlin_tradeparent', (
            ...
            ('shop', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('trade_type', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ...
        db.create_table(u'quanlin_shipping', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('buyer_nick', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ...
            ('receiver_mobile', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('receiver_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('receiver_phone', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('tid', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('company_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('out_sid', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('trade', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['quanlin.TradeParent'], null=True, blank=True)),
        ))
        db.send_create_signal(u'quanlin', ['Shipping'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'quanlin_shipping')
