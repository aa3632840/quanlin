...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Device.machine_model'
        db.add_column(u'oa_device', 'machine_model',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['oa.MachineModel']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device.machine_model'
        db.delete_column(u'oa_device', 'machine_model_id')
