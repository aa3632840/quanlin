...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VirtualData.matching_objects'
        db.add_column(u'vir2real_virtualdata', 'matching_objects',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VirtualData.matching_objects'
        db.delete_column(u'vir2real_virtualdata', 'matching_objects')
