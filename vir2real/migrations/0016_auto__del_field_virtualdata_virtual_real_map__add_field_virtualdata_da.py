...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VirtualData.virtual_real_map'
        db.delete_column(u'vir2real_virtualdata', 'virtual_real_map_id')

        # Adding field 'VirtualData.data_adapter'
        db.add_column(u'vir2real_virtualdata', 'data_adapter',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['vir2real.DataAdapter']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'VirtualData.virtual_real_map'
        db.add_column(u'vir2real_virtualdata', 'virtual_real_map',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['vir2real.Virtual2RealAdapterClassMap']),
                      keep_default=False)

        # Deleting field 'VirtualData.data_adapter'
        db.delete_column(u'vir2real_virtualdata', 'data_adapter_id')
