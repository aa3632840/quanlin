...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Device.brand' to match new field type.
        db.rename_column(u'oa_device', 'brand', 'brand_id')
        # Changing field 'Device.brand'
        db.alter_column(u'oa_device', 'brand_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oa.Brand'], null=True))
        # Adding index on 'Device', fields ['brand']
        db.create_index(u'oa_device', ['brand_id'])


    def backwards(self, orm):
        # Removing index on 'Device', fields ['brand']
        db.delete_index(u'oa_device', ['brand_id'])


        # Renaming column for 'Device.brand' to match new field type.
        db.rename_column(u'oa_device', 'brand_id', 'brand')
        # Changing field 'Device.brand'
        db.alter_column(u'oa_device', 'brand', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
