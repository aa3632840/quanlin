...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Shipping.post_fee'
        db.add_column(u'quanlin_shipping', 'post_fee',
        ...
        # Adding field 'Shipping.created'
        db.add_column(u'quanlin_shipping', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Shipping.modified'
        db.add_column(u'quanlin_shipping', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Shipping.post_fee'
        db.delete_column(u'quanlin_shipping', 'post_fee')

        # Deleting field 'Shipping.weight'
        db.delete_column(u'quanlin_shipping', 'weight')

        # Deleting field 'Shipping.created'
        db.delete_column(u'quanlin_shipping', 'created')

        # Deleting field 'Shipping.modified'
        db.delete_column(u'quanlin_shipping', 'modified')
    ...
    models = {
        ...
        u'quanlin.shipping': {
            ...
            'weight': ('django.db.models.fields.FloatField', [], {'max_length': '11', 'null': 'True', 'blank': 'True'})
        },
        u'quanlin.taocan': {
