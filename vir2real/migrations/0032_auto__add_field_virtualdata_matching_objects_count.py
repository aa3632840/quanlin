...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VirtualData.matching_objects_count'
        db.add_column(u'vir2real_virtualdata', 'matching_objects_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VirtualData.matching_objects_count'
        db.delete_column(u'vir2real_virtualdata', 'matching_objects_count')
