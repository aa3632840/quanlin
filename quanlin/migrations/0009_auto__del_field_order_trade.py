...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.trade'
        db.delete_column(u'quanlin_order', 'trade_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Order.trade'
        raise RuntimeError("Cannot reverse this migration. 'Order.trade' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Order.trade'
        db.add_column(u'quanlin_order', 'trade',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['quanlin.TradeParent']),
                      keep_default=False)
