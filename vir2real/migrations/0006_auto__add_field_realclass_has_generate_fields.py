...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RealClass.has_generate_fields'
        db.add_column(u'vir2real_realclass', 'has_generate_fields',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RealClass.has_generate_fields'
        db.delete_column(u'vir2real_realclass', 'has_generate_fields')
