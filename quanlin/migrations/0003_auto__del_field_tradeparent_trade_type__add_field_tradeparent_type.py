...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TradeParent.trade_type'
        db.delete_column(u'quanlin_tradeparent', 'trade_type')

        # Adding field 'TradeParent.type'
        db.add_column(u'quanlin_tradeparent', 'type',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TradeParent.trade_type'
        db.add_column(u'quanlin_tradeparent', 'trade_type',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'TradeParent.type'
        db.delete_column(u'quanlin_tradeparent', 'type')
