...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VirtualData.quick_job'
        db.add_column(u'vir2real_virtualdata', 'quick_job',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vir2real.QuickAddJob'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VirtualData.quick_job'
        db.delete_column(u'vir2real_virtualdata', 'quick_job_id')
