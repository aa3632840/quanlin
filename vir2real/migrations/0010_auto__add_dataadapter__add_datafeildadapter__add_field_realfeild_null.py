...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RealFeild.null'
        db.add_column(u'vir2real_realfeild', 'null',
                      self.gf('django.db.models.fields.BooleanField')(default=True, max_length=50),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'RealFeild.null'
        db.delete_column(u'vir2real_realfeild', 'null')
