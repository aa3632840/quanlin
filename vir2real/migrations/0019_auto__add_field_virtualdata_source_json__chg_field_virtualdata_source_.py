...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VirtualData.source_json'
        db.add_column(u'vir2real_virtualdata', 'source_json',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


        # Changing field 'VirtualData.source_line'
        db.alter_column(u'vir2real_virtualdata', 'source_line', self.gf('django.db.models.fields.TextField')(max_length=255))

    def backwards(self, orm):
        # Deleting field 'VirtualData.source_json'
        db.delete_column(u'vir2real_virtualdata', 'source_json')


        # Changing field 'VirtualData.source_line'
        db.alter_column(u'vir2real_virtualdata', 'source_line', self.gf('django.db.models.fields.CharField')(max_length=255))
