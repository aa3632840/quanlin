...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Shipping.trade'
        db.alter_column(u'quanlin_shipping', 'trade_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['quanlin.TradeParent'], null=True))

    def backwards(self, orm):

        # Changing field 'Shipping.trade'
        db.alter_column(u'quanlin_shipping', 'trade_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['quanlin.TradeParent']))
