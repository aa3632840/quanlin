...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RealFieldAlias.alias_choice'
        db.add_column(u'vir2real_realfieldalias', 'alias_choice',
                      self.gf('django.db.models.fields.CharField')(default=8, max_length=50),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'RealFieldAlias.alias_choice'
        db.delete_column(u'vir2real_realfieldalias', 'alias_choice')
