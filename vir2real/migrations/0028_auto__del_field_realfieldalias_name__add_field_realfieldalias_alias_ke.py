...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RealFieldAlias.name'
        db.delete_column(u'vir2real_realfieldalias', 'name')

        # Adding field 'RealFieldAlias.alias_key'
        db.add_column(u'vir2real_realfieldalias', 'alias_key',
                      self.gf('django.db.models.fields.CharField')(default='xxx', max_length=50),
                      keep_default=False)

        # Adding field 'RealFieldAlias.alias_value'
        db.add_column(u'vir2real_realfieldalias', 'alias_value',
                      self.gf('django.db.models.fields.CharField')(default='aa', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RealFieldAlias.name'
        db.add_column(u'vir2real_realfieldalias', 'name',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=50),
                      keep_default=False)

        # Deleting field 'RealFieldAlias.alias_key'
        db.delete_column(u'vir2real_realfieldalias', 'alias_key')

        # Deleting field 'RealFieldAlias.alias_value'
        db.delete_column(u'vir2real_realfieldalias', 'alias_value')
    ...
    models = {
        ...
        u'vir2real.realfieldalias': {
            ...
            'alias_value': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'real_field': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['vir2real.RealFeild']"})
        },
